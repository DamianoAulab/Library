<x-main>
    ...
    <div class="row justify-content-center">
        <div
            class="@if ($macro == 'motori') btn-light-orange @elseif ($macro == 'immobili') btn-orange @elseif ($macro == 'market') btn-red @endif fw-bold text-white mb-4 shadow text-uppercase fit-content fs-1 px-5 py-2 rounded">
            {{ $macro }}</div>
    </div>
    ...
    <div class="row g-4 mt-1">
        @forelse ($announcements as $announcement)
            @if ($announcement->is_accepted && $announcement->category->macro == $macro)
