        ...
        <div class="col-12 col-md-8">
            <form class="p-4 p-md-5 shadow rounded" wire:submit.prevent="store" enctype="multipart/form-data">
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="title" wire:model="title" placeholder="{{__('ui.title')}}">
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="description" wire:model="description" placeholder="{{__('ui.description')}}">
                ...
                <div class="form-floating mb-3">
                    <input type="number" class="form-control" step="0.01" id="price" wire:model="price" placeholder="{{__('ui.price')}}">
                ...
                <button type="submit" class="btn btn-red btn-lg px-5 w-100 fw-semibold">{{__('ui.createAnnouncement')}}</button>
            </form>
        </div>
    </div>
</div>
